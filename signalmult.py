...
class signalmult(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "signalmult", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("signalmult")
        ...
        self.settings = Qt.QSettings("GNU Radio", "signalmult")
...
def main(top_block_cls=signalmult, options=None):
