...
class prac3a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.Menu_grid_layout_1.addWidget(self._qtgui_vector_sink_f_0_0_win, 4, 0, 1, 2)
        for r in range(4, 5):
        ...
        self.Menu_grid_layout_1.addWidget(self._qtgui_vector_sink_f_0_win, 3, 0, 1, 2)
        for r in range(3, 4):
            self.Menu_grid_layout_1.setRowStretch(r, 1)
        for c in range(0, 2):
            self.Menu_grid_layout_1.setColumnStretch(c, 1)
        ...
        self.qtgui_time_sink_x_0_1.set_y_axis(-1.50, 1.50)
        ...
        self.Menu_grid_layout_0.addWidget(self._qtgui_time_sink_x_0_1_win, 3, 0, 1, 1)
        for r in range(3, 4):
        ...
        self.qtgui_time_sink_x_0_0.set_y_axis(-1.50, 1.50)
        ...
        self.Menu_grid_layout_0.addWidget(self._qtgui_time_sink_x_0_0_win, 1, 0, 1, 1)
        for r in range(1, 2):
            self.Menu_grid_layout_0.setRowStretch(r, 1)
        for c in range(0, 1):
            self.Menu_grid_layout_0.setColumnStretch(c, 1)
        ...
        self.fft_vxx_0_0 = fft.fft_vcc(N, True, [1]*N, True, 1)
        ...
        self.blocks_multiply_const_vxx_1_0 = blocks.multiply_const_vff([1/(N*samp_rate)]*N)
        ...
        self.VCO_hob_1 = VCO_hob_1.blk()
        self.VCO_hob = VCO_hob.blk(f=f, samp_rate=samp_rate)
        ...
        self.connect((self.VCO_hob, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.VCO_hob_1, 0), (self.blocks_stream_to_vector_0_0, 0))
        self.connect((self.VCO_hob_1, 0), (self.qtgui_time_sink_x_0_1, 0))
        ...
        self.connect((self.blocks_complex_to_mag_squared_0_0, 0), (self.epy_block_0_0, 0))
        self.connect((self.blocks_multiply_const_vxx_1, 0), (self.qtgui_vector_sink_f_0, 0))
        self.connect((self.blocks_multiply_const_vxx_1_0, 0), (self.qtgui_vector_sink_f_0_0, 0))
        self.connect((self.blocks_null_source_0, 0), (self.VCO_hob, 1))
        self.connect((self.blocks_null_source_0_0, 0), (self.VCO_hob_1, 1))
        self.connect((self.blocks_stream_to_vector_0, 0), (self.fft_vxx_0, 0))
        self.connect((self.blocks_stream_to_vector_0_0, 0), (self.fft_vxx_0_0, 0))
        self.connect((self.epy_block_0, 0), (self.blocks_multiply_const_vxx_1, 0))
        self.connect((self.epy_block_0_0, 0), (self.blocks_multiply_const_vxx_1_0, 0))
        ...
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.VCO_hob_1, 0))
    ...
    def set_Rb(self, Rb):
        ...
        self.qtgui_vector_sink_f_0_0.set_y_axis(0, 1/self.Rb)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.VCO_hob.samp_rate = self.samp_rate
        self.blocks_multiply_const_vxx_1.set_k([1/(self.N*self.samp_rate)]*self.N)
        self.blocks_multiply_const_vxx_1_0.set_k([1/(self.N*self.samp_rate)]*self.N)
        self.qtgui_time_sink_x_0.set_samp_rate(self.samp_rate)
        self.qtgui_time_sink_x_0_1.set_samp_rate(self.samp_rate)
        self.qtgui_vector_sink_f_0.set_x_axis(-self.samp_rate/2, self.samp_rate/self.N)
        self.qtgui_vector_sink_f_0_0.set_x_axis(-self.samp_rate/2, self.samp_rate/self.N)
